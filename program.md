...
- [ ] 11. 下載 5 首公版 MusicXML 到 `tests/fixtures/`（CC0 來源：MuseScore community / Mutopia Project）
- [ ] 12. 建 `app/models/score.py`（pydantic：title/key/bpm/time_signature/measures/chords/melody）
- [ ] 13. 建 `app/core/musicxml.py`：`parse(path: Path) -> Score`
- [ ] 14. 寫 `tests/test_musicxml_import.py`：5 首全綠
