...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("C#m7b5", "Em", id="csharp-half-diminished"),
        pytest.param("Gdim7", "N.C.", id="dim7"),
        pytest.param("Gdim", "N.C.", id="gdim"),
        pytest.param("Ddim", "N.C.", id="ddim"),
        pytest.param("Edim", "N.C.", id="edim"),
        pytest.param("G#dim", "N.C.", id="gsharp-dim"),
        pytest.param("Abdim", "N.C.", id="abdim"),
        pytest.param("Gm7b5", "Gm", id="g-half-diminished"),
        pytest.param("Em7b5", "Em", id="e-half-diminished"),
        pytest.param("Am7b5", "Am", id="a-half-diminished"),
